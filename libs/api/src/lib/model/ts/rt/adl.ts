...
export interface ATypeRef<_T> { value: AST.TypeRef }
export interface ATypeExpr<_T> { value: AST.TypeExpr }

/**
 * A function to obtain details on a declared type.
 */
export type DeclResolver = (decl: AST.ScopedName) => AST.ScopedDecl;;
