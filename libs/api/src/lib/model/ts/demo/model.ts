...
export const snDbTable: ADL.ScopedName = { moduleName: "demo.model",
name: "DbTable" };
...
export const snDbField: ADL.ScopedName = { moduleName: "demo.model",
name: "DbField" };
...
export const snUser: ADL.ScopedName = { moduleName: "demo.model",
name: "User" };
...
export const snAddress: ADL.ScopedName = { moduleName: "demo.model",
name: "Address" };
